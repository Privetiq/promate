            ...
            if ( $.wc_additional_variation_images_frontend.isCloudZoom() ) {
                ...
                if ( $.isFunction( $.fn.prettyPhoto ) ) {
                    ...
                    $( wc_additional_variation_images_local.lightbox_images ).prettyPhoto({
								...
								<div class="pp_content_container"> \
									...
									<div class="pp_right"> \
										<div class="pp_content"> \
											...
											<div class="pp_fade"> \
												<div class="button-switcher-new button-prev-click"></div> \
												<div id="pp_full_res" class="col-md-8 col-sm-8"> \
												</div> \
												<div class="button-switcher-new button-next-click"></div> \
											</div> \
                        ...
                        gallery_markup: '<div class="pp_gallery col-md-4 col-sm-4"> \
								<div class="gallery_arrows gallery_go_top"></div> \
								<a href="#" class="pp_arrow_previous">Previous</a> \
								<div class="galley_cover_new"> \
									<div class="ppt">&nbsp;</div>\
									<ul> \
										{gallery} \
									</ul> \
								...
								<div class="gallery_arrows gallery_go_bot"></div> \
							</div>',
