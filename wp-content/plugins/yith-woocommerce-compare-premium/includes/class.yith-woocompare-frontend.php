...
if( !class_exists( 'YITH_Woocompare_Frontend' ) ) {
    ...
    class YITH_Woocompare_Frontend {
        ...
        public function populate_products_list(){
            ...
            if( defined( 'ICL_LANGUAGE_CODE' ) && $lang && isset( $sitepress ) && function_exists('wpml_object_id_filter') ) {
                $sitepress->switch_lang( $lang, true );

                $the_list = isset( $_COOKIE[ $this->cookie_name ] ) ? json_decode( maybe_unserialize( $_COOKIE[ $this->cookie_name ] ) ) : array();
        ...
        protected function _vars( $products = array() ) {
            ...
            $show_title     = get_option( 'yith_woocompare_fields_product_info_title' ) == 'yes' ? true : false;
	        $show_image     = get_option( 'yith_woocompare_fields_product_info_image' ) == 'yes' ? true : false;
	        $show_add_cart  = get_option( 'yith_woocompare_fields_product_info_add_cart' ) == 'yes' ? true : false;
