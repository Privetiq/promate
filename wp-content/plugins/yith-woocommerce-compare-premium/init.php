<?php
/**
 * Plugin Name: YITH WooCommerce Compare Premium-Null24.Net
...
function yith_woocompare_premium_constructor() {
    ...
    require_once('includes/class.yith-woocompare-admin-premium.php');
    require_once('includes/class.yith-woocompare-frontend.php');
    require_once('includes/class.yith-woocompare-frontend-premium.php');
