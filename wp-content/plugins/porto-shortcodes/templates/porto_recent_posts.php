...
if ($posts->have_posts()) {
    ...
    ?>
    <div class="row">
        <div class="post-carousel owl-carousel show-nav-title" data-cols-lg="<?php echo $items_desktop ?>" data-cols-md="<?php echo $items_tablets ?>" data-cols-sm="<?php echo $items_mobile ?>">
            <?php
