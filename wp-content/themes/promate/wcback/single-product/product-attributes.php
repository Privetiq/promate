...
<ul class="product-extrainfo">
	...
	<?php if ( $product->enable_dimensions_display() ) : ?>
		...
		<?php if ( $product->has_weight() ) : $has_row = true; ?>
			<li class="<?php if ( ( $alt = $alt * -1 ) === 1 ) echo 'alt'; ?>">
				<span class="space"><?php _e( 'Weight', 'woocommerce' ) ?></span>
		...
		<?php if ( $product->has_dimensions() ) : $has_row = true; ?>
			<li class="<?php if ( ( $alt = $alt * -1 ) === 1 ) echo 'alt'; ?>">
				<span class="space"><?php _e( 'Dimensions', 'woocommerce' ) ?></span>
	...
	<?php foreach ( $attributes as $attribute ) :
		...
		?>
		<li class="<?php if ( ( $alt = $alt * -1 ) == 1 ) echo 'alt'; ?>">
			<span class="space"><?php echo wc_attribute_label( $attribute['name'] ); ?></span>
			<?php
