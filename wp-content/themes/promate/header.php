...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo esc_url( get_template_directory_uri() ); ?>/favicon.ico"/>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/jquery.fancybox.min.css" type="text/css" />
    ...
    <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/new_one.css" type="text/css" />
...
<!--    <script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>-->
    ...
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/jquery.fancybox.min.js" type="text/javascript"></script>

    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/phone.js" type="text/javascript"></script>
    ...
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/jquery.zoom.js" type="text/javascript"></script>
    ...
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/bootstrap-tabcollapse.js" type="text/javascript"></script>
    <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/new_one.js" type="text/javascript"></script>
    ...
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        })(window,document,'script','dataLayer','GTM-T6QG2LN');</script>
    <!-- End Google Tag Manager -->
</head>
<body class="<?php echo (count($_GET) == 0) ? 'no-get' : 'has-get';?>">

<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T6QG2LN"
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
        <?php
        $walker = do_action('add_walker_promate');
        wp_nav_menu( array(
            'menu_id' 		 => 'fxmenu1',
            'menu_class'     => 'nav sidebar-nav',
            'theme_location' => 'mobile1',
    ...
    <div class="super_main-header">
                ...
                <div class="block blockequalize equal-column  row">
                    <div class="col-md-3 col-sm-5 col-xs-8">
                        <div class="header_mobile_phone">
                            <i class="fa fa-phone" aria-hidden="true"></i><span>+38 (044) 338-40-41</span>
                        </div>
                    ...
                    <div class="col-md-5 col-sm-7 col-xs-4">
                        <?php
                        wp_nav_menu( array(
                            'menu_class'     => 'menu pull-right hidden-md hidden-lg',
                            'theme_location' => 'mobile',
                            'link_before'    => '<span>',
                            'link_after'     => '</span>',
                        ) );
                        ?>
                        <div class="position position-panel-2 hidden-sm hidden-xs">
                            <div class="jv-module">
        ...
        <div class="block-panel-wrapper headroom headroom--pinned headroom--top">
            <!--Block Header -->
                    ...
                    <div class="position position-logo">
                        <div class="jv-module module logo logo-homepage-1">
                            <div class="contentmod clearfix">
                                <div class="custom promate_logo">
                                    <p><?php echo( promate_logo() ); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="block-panel-full-site">
                ...
                <div class="position position-panel-full-site">
                    <div class="jv-module  module panel-extra-info responsive-headinfo">
                        <div class="container">
                            <div class="contentmod dopcontentmod clearfix">
                                <div class="custom">
                                    <div class="clearfix">
                                        <ul>
                                            <li>
                                                <div class="extra-info--block">
                                                    ...
                                                    <span><span class="uppercase"><?php echo __('Время');?></span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo get_theme_mod( "_days");?></span></span> <span> <span class="uppercase">Работы</span><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo get_theme_mod( "_time");?></span></span>
                                                </div>
                                            </li>
                                            <li>
        ...
        <div class="custom-nekit promate_logo">
            <p><?php echo( promate_logo() ); ?></p>
        </div>
        <div class="w100">
            <div class="responsive-layout">
                <div class="responsive-layout--top clearfix">
                    <div class="responsive-layout--logo" data-responsive-prev=".position.position-logo" data-responsive-selector=".jv-module.module.logo">
                        <div class="contentmod clearfix">
                            <div class="custom">
                                <p><?php echo( promate_logo() ); ?></p>
                            </div>
                ...
                <div class="responsive-layout--bottom clearfix">
                    <div class="responsive-layout--menu">
								<span>
									<a class="flexMenuToggle hamburger is-closed" type="button" data-toggle="offcanvas">
										<span></span>
										<span></span>
										<span></span>
									</a>
                    ...
                    <div class="responsive-layout--cart" data-responsive-prev=".menu-jvajaxcart" data-responsive-selector=".menu-jvajaxcart > .jv-module.module.module--cart-ajax">
                        <div class="contentmod clearfix">
