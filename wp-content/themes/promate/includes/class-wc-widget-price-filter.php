 ...
 * @extends  WC_Widget
 */
class Promate_Price_Filter extends WC_Widget_Price_Filter {
...
function promate_register_widgets() {
	register_widget( 'Promate_Price_Filter' );
}

add_action( 'widgets_init', 'promate_register_widgets' );