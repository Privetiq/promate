...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo $product_id ?>">
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	        ...
	        <a href="<?php echo esc_url( $wishlist_url )?>" class="btn btn-primary" rel="nofollow">
	...
	<?php else: ?>
		<a href="<?php echo esc_url( add_query_arg( array( 'wishlist_notice' => 'true', 'add_to_wishlist' => $product_id ), get_permalink( wc_get_page_id( 'myaccount' ) ) ) )?>" rel="nofollow" class="btn btn-primary <?php echo str_replace( 'add_to_wishlist', '', $link_classes ) ?>" >
			<i class="fa fa-heart"></i>
